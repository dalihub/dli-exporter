#ifndef LIBDLI_JSON_READER_H_
#define LIBDLI_JSON_READER_H_
/*
...
struct LIBDLI_API Read
{
  ...
  static dli::StringView StringView(const json_value_s& j)
  {
    auto& js = Cast<json_string_s>(j);
    return dli::StringView(js.string, js.string_size);
  }
