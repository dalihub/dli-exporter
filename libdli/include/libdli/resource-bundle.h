#ifndef LIBDLI_RESOURCE_BUNDLE_H_
#define LIBDLI_RESOURCE_BUNDLE_H_
/*
...
// INTERNAL
#include "mesh-definition.h"
#include "material-definition.h"
#include "environment-definition.h"
#include "shader-definition.h"
#include "skeleton-definition.h"
...
public:
  struct Options
  {
    ...
    enum Value : Type {
      ...
      KeepUnused = NthBit(1)  // Don't reset handles to resources that had a 0 reference count.
    };
  };
...
#endif //LIBDLI_RESOURCE_BUNDLE_H_
