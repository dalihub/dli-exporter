#ifndef LIBDLI_SCENE_DEFINITION_H_
#define LIBDLI_SCENE_DEFINITION_H_
/*
...
public: // METHODS
  ...
  Dali::Actor CreateNodes(Index iNode, const Customization::Choices& choices,
  ...
  void ApplyConstraints(Dali::Actor& root,
  ...
  /// other actors.
  void ConfigureSkeletonJoints(uint32_t iRoot, const SkeletonDefinition::Vector& skeletons, Dali::Actor rootActor) const;
  ...
  void ConfigureSkinningShaders(const ResourceBundle& resources,
    Dali::Actor root, std::vector<SkinningShaderConfigurationRequest>&& requests) const;
  ...
  bool ConfigureBlendshapeShaders(const ResourceBundle& resources,
    Dali::Actor root, std::vector<BlendshapeShaderConfigurationRequest>&& requests,
    StringCallback onError = DefaultErrorCallback) const;
...
#endif //LIBDLI_SCENE_DEFINITION_H_
