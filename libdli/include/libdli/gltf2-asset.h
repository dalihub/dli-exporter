#ifndef LIBDLI_GLTF2_ASSET_H_
#define LIBDLI_GLTF2_ASSET_H_
/*
...
struct Ref
{
  ...
  dli::Index GetIndex() const { return mIndex; }
...
typename T::Type ReadStringEnum(const json_value_s& j)
{
  ...
  return T::FromString(str, str.size());
}
