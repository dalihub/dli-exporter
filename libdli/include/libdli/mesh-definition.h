#ifndef LIBDLI_MESH_DEFINITION_H
#define LIBDLI_MESH_DEFINITION_H
/*
...
struct MeshDefinition
{
  ...
  struct RawData
  {
    struct Attrib
    {
      ...
      void AttachBuffer(Dali::Geometry& g) const;
    };
    ...
    Dali::PixelData mBlendShapeData;
  };
...
public: // DATA
  ...
  uint32_t mFlags = 0x0;
  Dali::Geometry::Type mPrimitiveType = Dali::Geometry::TRIANGLES;
  std::string mUri;
  Accessor mIndices;
  Accessor mPositions;
...
#endif //LIBDLI_MESH_DEFINITION_H
