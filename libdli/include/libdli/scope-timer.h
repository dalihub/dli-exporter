#ifndef LIBDLI_SCOPE_TIMER_H_
#define LIBDLI_SCOPE_TIMER_H_
/*
...
#define SCOPE_TIMER_FRAME dli::ScopeTimer SCOPE_TIMER_UNIQUE_NAME(privateScopeTimer)(__FUNCTION__ ":" SCOPE_TIMER_QUOTE(__LINE__))

#endif //LIBDLI_SCOPE_TIMER_H_
