#ifndef LIBDLI_SHADER_UTILS_H_
#define LIBDLI_SHADER_UTILS_H_
/*
...
struct ShaderCreator
{
  ...
  Dali::Shader Create(Dali::Shader::Hint::Value hints = Dali::Shader::Hint::NONE) const;
};
