...
Dali::Actor NodeDefinition::CreateActor(CreateParams& params) const
{
...
void ModelNode::OnCreate(const NodeDefinition& node, NodeDefinition::CreateParams& params, Dali::Actor& actor) const
{
...
void ArcNode::GetEndVectorWithDiffAngle(float startAngle, float diffAngle, Dali::Vector2& endVector)
{
  float endAngle = 0.f;
