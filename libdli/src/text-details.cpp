...
#include "libdli/view-projection.h"
...
{
  const Dali::Vector2& dpi = Dali::Stage::GetCurrent().GetDpi();
 ...
 */
bool ClipToWindow(const Dali::Vector4& position, float viewportWidth, float viewportHeight, Dali::Vector4& windowPos)
{
 ...
 */
bool WindowToClip(const Dali::Vector4& windowPos, float viewportWidth, float viewportHeight, Dali::Vector4& position )
{
