...
// INTERNAL INCLUDES
#include "libdli/material-definition.h"
...
constexpr SamplerFlags::Type SamplerFlags::Encode(FilterMode::Type minFilter, FilterMode::Type magFilter, WrapMode::Type wrapS, WrapMode::Type wrapT)
{
...
constexpr FilterMode::Type SamplerFlags::GetMinFilter(Type flags)
{
  return FILTER_MODES_TO_DALI[flags & FILTER_MIN_MASK];
}

constexpr FilterMode::Type SamplerFlags::GetMagFilter(Type flags)
{
  return FILTER_MODES_TO_DALI[(flags >> FILTER_MAG_SHIFT) & FILTER_MAG_MASK];
}

constexpr WrapMode::Type SamplerFlags::GetWrapS(Type flags)
{
  return WRAP_MODES_TO_DALI[(flags >> WRAP_S_SHIFT) & WRAP_S_MASK];
}

constexpr WrapMode::Type SamplerFlags::GetWrapT(Type flags)
{
