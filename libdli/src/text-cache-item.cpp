...
const EmbeddedItemCache* const FindEmbeddedItemCache( const std::vector<EmbeddedItemCache>& embeddedItemCache, const std::string& url, uint16_t x, uint16_t y, uint16_t width, uint16_t height, Dali::Degree angle )
{
  ...
  TextCacheItem::Localizer getLocalisedText)
{
  ...
  Dali::Vector<Dali::Toolkit::DevelText::EmbeddedItemInfo> embeddedItemsInfo;
  Dali::Devel::PixelBuffer pixelBuffer = Dali::Toolkit::DevelText::Render(parameters.textParameters, embeddedItemsInfo);

  // Process the drop shadow.
  if( Dali::Vector2::ZERO != parameters.shadowOffset)
  {
    ...
    pixelBuffer = Dali::Toolkit::DevelText::CreateShadow(shadowParameters);
  }
  ...
  {
    const Dali::Toolkit::DevelText::EmbeddedItemInfo& embeddedItemInfo = embeddedItemsInfo[index];
    ...
    Dali::Devel::PixelBuffer itemPixelBuffer;
    Dali::Pixel::Format itemPixelFormat = Dali::Pixel::A8;
    ...
    {
      itemPixelBuffer = Dali::LoadImageFromFile(parameters.embeddedItems[index]);
      ...
      if ((Dali::Pixel::A8 == pixelBuffer.GetPixelFormat()) && (Dali::Pixel::RGBA8888 == itemPixelFormat))
      {
        pixelBuffer = Dali::Toolkit::DevelText::ConvertToRgba8888( pixelBuffer, parameters.textParameters.textColor, true );
      }
      else if ((Dali::Pixel::RGBA8888 == pixelBuffer.GetPixelFormat()) && (Dali::Pixel::A8 == itemPixelFormat))
      {
        itemPixelBuffer = Dali::Toolkit::DevelText::ConvertToRgba8888(itemPixelBuffer, parameters.textParameters.textColor, true );
        itemPixelFormat = Dali::Pixel::RGBA8888;
      }
    ...
    if( Dali::TextAbstraction::ColorBlendingMode::MULTIPLY == embeddedItemInfo.colorBlendingMode )
    {
  ...
  if ((parameters.textParameters.textWidth != pixelData.GetWidth()) || (parameters.textParameters.textHeight != pixelData.GetHeight()))
  {
    ...
    parameters.texture = Dali::Texture::New(Dali::TextureType::TEXTURE_2D,
    ...
    sampler.SetFilterMode( Dali::FilterMode::NEAREST, Dali::FilterMode::NEAREST );
